    ...
    <div id="wrap">
        ...
        <div id="left-main"> &nbsp;
            ...
            <form action="search.fd">
                ...
                <div>
                    <input type="text" name="keyword" value="${ f.keyword }" placeholder="검색 내용을 입력해주세요" style=" border: 0.5px solid gray; height: 2.5em; width: 100%; border-radius: 10px; text-align: center; position: relative;"> <br><br>
